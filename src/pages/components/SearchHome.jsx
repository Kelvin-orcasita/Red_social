    ...
    <>
      ...
      <form ref={form} onSubmit={hangleSearch} className='mt-10'>
        <div className='relative mx-6 lg:mx-20 '>
          ...
          <button
            type='submit'
            className='text-white absolute end-2.5 bottom-2.5 bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-500 dark:focus:ring-blue-800'
          >
            Search
          </button>
        </div>
      ...
      {search == null || search == [''] || search == undefined ? (
        <div className='flex justify-center items-center mt-10'>
          <h1>No hay datos encontrados</h1>
        </div>
      ) : (
        <section>
