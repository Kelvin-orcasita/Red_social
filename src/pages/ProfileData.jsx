...
export function ProfileData() {
  ...
  useEffect(() => {
    if (user == null || profile.name !== 'Undefined name') {
      navigate('/')
    }
    getMyProfileSesion()
  }, [])
  ...
  async function handleSubmit(event) {
    ...
    if (form.current.username.value == 'Undefined name') {
      return alert('You must use a name.')
    }
    ...
    if (result == null) {
      return alert('Error in update profile.')
    } else {
      navigate('/')
    }
  }
